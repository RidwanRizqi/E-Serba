<nav class="bg-white border-gray-200 dark:bg-blue-800 fixed w-full top-0 left-0 border-b dark:border-gray-600 z-40">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
        <a href="{{ url('/') }}" class="flex items-center">
            <img src="{{ asset('assets/images/logo.png') }}"
                class="h-20 mr-3" alt="E-shirts Logo">
        </a>
        <div class="flex md:order-2">
            @auth
                <div class="md:me-3">
                    ...
                    <div id="cart"
                        class="z-10 hidden font-normal divide-y rounded-lg shadow w-44 dark:bg-blue-950 dark:divide-gray-600">
                ...
                <div id="user"
                    class="z-10 hidden font-normal divide-y rounded-lg shadow w-auto dark:bg-blue-950 dark:divide-gray-600">
            ...
            @else
                <a href="{{ route('login') }}"
                    class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-950 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-blue-600">Login</a>
                <a href="{{ route('register') }}"
                    class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-950 dark:text-white dark:border-blue-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Sign
                    Up</a>
            @endauth
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                class="flex flex-col p-4 md:p-0 mt-4 font-medium items-center border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-blue-800 dark:border-gray-700">
                <li>
                    <a href="#"
                ...
                <li>
                    ...
                    <div id="brand"
                        ...
                        <ul class="py-2 text-sm text-white dark:text-white"
                            ...
                            <li>
                                <a href="{{ url('/') }}"
                                    class="block px-4 py-2 dark:hover:bg-gray-600 dark:hover:text-white">Semua Kategori</a>
                            </li>
                ...
                <li>
                    <a href="#"
                        class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Butuh Bantuan?</a>
                </li>
                <li>
                    <form action="{{ url('/searchs') }}" method="GET" class="flex items-center">
                        ...
                        <div class="relative w-full">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-white"
                            ...
                            <input type="text" id="search" name="search"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-blue-950 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <button type="submit"
