        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ url('/admin/dashboards') }}" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('assets/images/logo.png') }}"
                        class="h-14 mr-3" alt="E-shirts Logo" />
                </a>
            </div>
            <div class="flex items-center">
                <div class="flex items-center ml-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-blue-950 dark:divide-gray-600"
                        id="dropdown-user">
