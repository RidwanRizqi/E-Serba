    ...
    <div class="container mx-auto p-5">
        ...
        <div
            ...
            <div class="px-5 pb-5">
                ...
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Purchaser: {{ $purchase->user->name }}</p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Category:
                    {{ $purchase->product->category->name }}</p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Supplier's Name:
                    {{ $purchase->supplier->name }}</p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Purchased Quantity:
                    {{ $purchase->quantity }}
                </p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Amount: {{ $purchase->amount }}$</p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Value-Added Tax: {{ $purchase->vat }}$
                </p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white p-1">Total Amount:
